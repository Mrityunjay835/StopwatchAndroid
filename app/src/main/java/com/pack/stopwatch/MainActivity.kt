...
import com.pack.stopwatch.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    //broadcast receiver for receive the value and it is responsible for print the time
    ...
    private fun getFormattedTime(time:Double):String{
        ...
        val minuntes = timeInt % 86400 % 3600 / 60
        val secound = timeInt % 86400 % 3600 % 60
        return  String.format("%02d:%02d:%02d",hours,minuntes,secound)
    }
